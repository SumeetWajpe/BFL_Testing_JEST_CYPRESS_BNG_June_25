...
describe("test suite for Pokemon Service", () => {
  ...
  it("tests if pokemon service - getPokemonData receives the data from API", () => {
    ...
    const pokemonServObj = TestBed.inject(PokemonService);// use Angular DI for the service
    pokemonServObj.getPokemonData("pokemon/ivysaur").subscribe(data => {

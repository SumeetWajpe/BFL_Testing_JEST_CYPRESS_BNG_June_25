...
export class PokemonService {
  ...
  setPokemonGenders(malePokemons: any, femalePokemons: any, genderless: any) {
    this.genderPokemons.male = malePokemons.pokemon_species_details.map(
      (el: any) => {
        return el.pokemon_species.name;
      },
    );
    this.genderPokemons.female = femalePokemons.pokemon_species_details.map(
      (el: any) => {
        return el.pokemon_species.name;
      },
    );
    this.genderPokemons.genderless = genderless.pokemon_species_details.map(
      (el: any) => {
        return el.pokemon_species.name;
      },
    );
